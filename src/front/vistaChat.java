						...
						.addGroup(gl_contentPane.createSequentialGroup().addGap(14).addGroup(gl_contentPane
								...
								.addGroup(Alignment.TRAILING,
										gl_contentPane.createSequentialGroup()
												.addComponent(txtIngreseTextoAqui, GroupLayout.DEFAULT_SIZE, 295,
														Short.MAX_VALUE)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addComponent(lblNewLabel)
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
								.addComponent(txtIngreseTextoAqui, GroupLayout.PREFERRED_SIZE, 26,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(btnEnviar))
						.addPreferredGap(ComponentPlacement.RELATED, 9, Short.MAX_VALUE).addComponent(btnAbandonar)
						.addContainerGap()));
